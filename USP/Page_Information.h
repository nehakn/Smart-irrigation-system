...
void send_information_values_html ()
{
	...
	values += "x_ntp|" +  (String) DateTime1.hour + ":" + (String) + DateTime1.minute +  ":"  + (String)  DateTime1.second + " " + (String)   DateTime1.year + "-" + (String)  DateTime1.month + "-" + (String)  DateTime1.day +  "|div\n";
